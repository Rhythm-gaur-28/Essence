...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-[65vh]">
            ...
            <div className="animate-fade-in z-10">
              ...
              <div className="flex items-center gap-6 mt-10">
                ...
                <div>
                  <p className="font-heading text-2xl font-bold text-foreground">{brands.length || 5}</p>
      ...
      {/* Best Selling Products — hidden if none marked */}
      {bestSellers.length > 0 && (
        <section className="section-padding">
          <div className="container mx-auto">
            <div className="flex items-end justify-between mb-10">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-red-600 font-medium mb-2">Top Picks</p>
                <h2 className="font-heading text-3xl md:text-4xl font-bold">Best Sellers</h2>
              </div>
              <Link to="/shop?bestSeller=true" className="text-sm text-primary font-medium hover:underline flex items-center gap-1">
                View All <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-7">
      ...
      {/* Dynamic Banner Carousel — renders nothing if no active banners */}
      <HomeBanner />
