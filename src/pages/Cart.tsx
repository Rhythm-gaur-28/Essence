...
const Cart = () => {
  ...
  const [couponStatus, setCouponStatus] = useState<'applied' | 'invalid' | null>(null);
          ...
          <div className="mb-4">
            {appliedCoupon ? (
              <div className="flex items-center justify-between bg-primary/10 rounded-lg p-3">
                ...
                <button
                  onClick={() => { removeCoupon(); setCouponStatus(null); }}
              ...
              <div className="space-y-2">
                ...
                {couponStatus === 'invalid' && (
                  <p className="text-xs text-destructive font-medium">Coupon Invalid</p>
                )}
              </div>
            )}
          </div>
